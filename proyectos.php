    ...
    <div class="container">
        <div class="container">
            <div class="row text-center">
                <div class="col-lg-3 col-md-6 col-sm-6" style="height: 30px !important;"><span class="categoria" id="todos">Todos</span></div>
                <div class="col-lg-3 col-md-6 col-sm-6" style="height: 30px !important;"><span class="categoria" onclick="cargarGaleria('comercial')" id="remodelacion">Remodelaci&oacute;n</span></div>
                <div class="col-lg-3 col-md-12 col-sm-12" style="height: 30px !important;"><span class="categoria" onclick="cargarGaleria('corporativo')" id="diseños">Diseños</span></div>
                <div class="col-lg-3 col-md-12 col-sm-12" style="height: 30px !important;"><span class="categoria" onclick="cargarGaleria('residencial')" id="kioscos">Kiosc  os</span></div>
            </div>
        </div>
    </div>
	<div class="row">
