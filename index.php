...
<div class="container">
	...
	<div class="row" class="justify-content-center">
		...
		<div class="col-lg-4 col-md-12">
			<h4 class="tparr" style="font-weight: bold;">Dise&ntilde;os</h4>
			<p class="parr" style="height: 167px; overflow: hidden;">
				Con la experiencia de nuestra &aacute;rea creativa, especializada en arquitectura de interiores somos capaces de desarrollar proyectos vanguardistas enfocados en el dise&ntilde;o.
			</p>
		...
		<div class="col-lg-4 col-md-12">
			...
			<p class="parr" style="height: 167px; overflow: hidden;">Con la experiencia de nuestra &aacute;rea creativa, especializada en arquitectura de interiores somos capaces de desarrollar proyectos vanguardistas enfocados en el dise&ntilde;o.</p>
			<div style="background: black;">
